...
var format_Gruposquesufrenmayordesigualdad_0 = new ol.format.GeoJSON();
var features_Gruposquesufrenmayordesigualdad_0 = format_Gruposquesufrenmayordesigualdad_0.readFeatures(json_Gruposquesufrenmayordesigualdad_0, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Gruposquesufrenmayordesigualdad_0 = new ol.source.Vector({
    attributions: [new ol.Attribution({html: '<a href=""></a>'})],
});
jsonSource_Gruposquesufrenmayordesigualdad_0.addFeatures(features_Gruposquesufrenmayordesigualdad_0);var lyr_Gruposquesufrenmayordesigualdad_0 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Gruposquesufrenmayordesigualdad_0, 
                style: style_Gruposquesufrenmayordesigualdad_0,
    title: '<b/>Percepción sobre grupos de personas que sufren más desigualdad:</b><br />El degradado de colores en el mapa indica el porcentaje de <br /> personas que creen los <b/>adultos mayores (65 años)</b> son los que<br />sufren más desigualdad.<br /><br />\
