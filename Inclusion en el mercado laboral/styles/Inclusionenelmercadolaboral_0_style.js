...
var style_Inclusionenelmercadolaboral_0 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("q2wHide_Incrementar el trabajo a tiempo parcial y trabajos desde casa (%)");
    var labelText = "";
    size = 0;
