...
jsonSource_Trabajodeloshombresconninos_0.addFeatures(features_Trabajodeloshombresconninos_0);var lyr_Trabajodeloshombresconninos_0 = new ol.layer.Vector({
    ...
    title: '<b/>Percepción sobre las tareas del hogar:</b><br />El degradado de colores en el mapa indica el porcentaje de <br />personas que <b/>tienden a estar de acuerdo</b> en que los hombres<br />están menos calificados que las mujeres para realizar las tareas<br />en el hogar.<br /><br />\
...
lyr_Trabajodeloshombresconninos_0.set('fieldAliases', {'Codigo': 'Codigo', 'Canton': 'Canton', 'Provincia': 'Provincia', 'Grafica': 'Grafica', 'Año': 'Año', 'Tiendo a e': 'Tiendo a e', });
lyr_Trabajodeloshombresconninos_0.set('fieldImages', {'Codigo': 'Hidden', 'Canton': 'TextEdit', 'Provincia': 'TextEdit', 'Grafica': 'Photo', 'Año': 'TextEdit', 'Tiendo a e': 'Hidden', });
